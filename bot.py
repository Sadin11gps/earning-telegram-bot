...
from withdraw import setup_withdraw_handlers
...
main_menu_keyboard = ReplyKeyboardMarkup(
    [
        ...
        # ফিক্সড: ইমোজি ছাড়া শুধু 'WITHDRAW NOW' ব্যবহার করা হয়েছে
...
async def process_text_messages(client, message):
    ...
    if message.text.strip() == "WITHDRAW_NOW":
        return
...
setup_withdraw_handlers(app, USER_STATE, group=-1) 
